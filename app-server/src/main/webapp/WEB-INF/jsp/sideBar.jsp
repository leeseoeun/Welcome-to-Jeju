...
<div class="side-menu-bar">
  ...
  <!-- 로그인 -->
  <c:if test="${not empty loginUser && loginUser.nickname ne '제주정승'}">
    <div class="my-menu-box">
      <ul class="my-menu-list">
        <a href="${contextRoot}/app/auth/userinfo">
          <li><span class="emozi">📝</span><span class="name">나의 정보</span></li>
        </a>
        ...
        <div class="btn-group">
          <button type="button" class="btn btn-default dropdown-toggle"
            ...
            <span class="emozi">&nbsp;🙆</span><span class="name" style="font-size: large">좋아요</span>
          </button>
          <ul class="dropdown-menu" role="menu">
            <li style="font-size: medium"><a href="${contextRoot}/app/likedtheme/list">
              <span class="emozi">💗</span><span class="name">좋아하는 테마</span>
            </a></li>
            <li style="font-size: medium"><a href="${contextRoot}/app/likeduser/list">
              <span class="emozi">💗</span><span class="name">좋아하는 유저</span>
            </a></li>
          </ul>
        </div>  <!-- .btn-group -->
  ...
  <div class="public-menu-box">
    <ul class="public-menu-box-list">
      ...
      <a href="${contextRoot}/app/board/list">
        <li><span class="emozi">📋</span><span class="name">자유 게시판</span></li>
      </a>
    </ul>
  </div> <!-- public-menu-box -->
    ...
    <div class="public-menu-box">
      <ul class="public-menu-box-list">
        <a href="${contextRoot}/app/admin/themelist">
          <li><span class="emozi">⛱️‍</span><span class="name">테마 관리</span></li>
        </a>
        <a href="${contextRoot}/app/admin/userlist">
          <li><span class="emozi">🏄‍♀️</span><span class="name">회원 관리</span></li>
        </a>
